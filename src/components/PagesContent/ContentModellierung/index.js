...
const content = [
  ...
  },
  {
    ...
    button: "Mehr dazu",
    image:
      "https://www.reisewut.com/bilder/mosel/geierlay-haengebruecke7.jpg",
    flaeche: "350",
    raeume: "9",
    bewohner: "5",
  ...
  },
  {
    ...
    button: "Mehr dazu",
    image:
      "https://medien.bremen.de/media/w/480/IMG_3957.JPG",
    flaeche: "140",
    raeume: "9",
    bewohner: "5",
...
const ContentModellierung = () => {
  ...
  const validate = () => {
    return (standort !== "" && fläche !== null && rooms !== null && bewohner !== null)
  };
...
*/
  return (
    <Container>
      ...
      <Text>
      Mit unserem Vergleichsrechner können Sie das optimale Heizsystem für Ihr neues Einfamilienhaus berechnen. Vergleichen Sie zum Beispiel das Vestaxx Heizfenstersystem mit einer Pelletheizung oder einer Wärmepumpe. Wählen Sie dafür einfach den Grundriss eines unserer zu Ihrem Traumhaus passenden Musterhäuser aus und legen Sie direkt los. Oder füllen Sie das unten befindliche Formular aus und machen damit Ihren ganz eigenen Heizvergleich, mit den auf Sie zugeschnittenen Daten.
      </Text>
      <br />
      <br />
      ...
      <br />
      <Image>
        <button className="pointer" type="submit" onClick={() => setShow1((prev) => !prev)}>
          Wählen Sie aus
        </button>
      </Image>{" "}
      {show1 && (
      ...
      <form onSubmit={handleSubmit}>
        <InputDiv>
        <h5>Gebäudedaten und Standort  <FontAwesomeIcon icon={solid('house-chimney-window')} /></h5>
       
        <InputFieldText><span className="tooltip">Bundesland*  <FontAwesomeIcon icon={solid('circle-question')} />
            <span className="tooltiptext"> Tragen Sie hier das von Ihnen gewünschte Bundesland ein. Der Ort, an dem sich Ihr Gebäude befindet, wirkt sich auf den Ertrag der Photovoltaik-Anlage aus.</span>
          </span>
        </InputFieldText>
        ...
        <DropdownList
              ...
              data={["Baden-Württemberg", "Bayern", "Berlin", "Brandenburg", "Bremen", "Hamburg", "Hessen", "Mecklenburg-Vorpommern", "Niedersachsen", "Nordrhein-Westfalen", "Rheinland-Pfalz", "Saarland", "Sachsen", "Sachsen-Anhalt", "Schleswig-Holstein", "Thüringen"]}
        />
        
        
        
        <InputFieldText><span className="tooltip"> Gebäudenutzfläche in m² *   <FontAwesomeIcon icon={solid('circle-question')} />  
            <span className="tooltiptext">  Tragen Sie hier die Gebäudenutzfläche Ihres Gebäudes ein. Die Gebäudenutzfläche ist die gesamte Fläche Ihres Gebäudes und umfasst auch Räume, die nicht direkt bewohnt sind, wie Flure oder Treppenräume. Vereinfacht können sie Ihre Gebäudenutzfläche auch bestimmen, in dem Sie die Wohnfläche mit dem Faktor 1,2 multiplizieren.</span>
          </span>
        </InputFieldText>
        <NumberPicker
              value={fläche}
        ...
        <InputFieldText><span className="tooltip">  Anzahl beheizter Räume*   <FontAwesomeIcon icon={solid('circle-question')} />
            <span className="tooltiptext"> Tragen Sie hier die Anzahl der Räume ein, die in Ihrem Haus beheizt werden (sollen), also die Wohnräume. Dazu zählen unter anderem das Wohnzimmer oder das Badezimmer, aber in der Regel nicht der Flur oder Treppenräume.</span>
          </span></InputFieldText>
        <NumberPicker
              value={rooms}
        ...
        <InputFieldText> <span className="tooltip">  Bewohneranzahl*  <FontAwesomeIcon icon={solid('circle-question')} />
            <span className="tooltiptext"> Tragen Sie hier die Anzahl der Bewohner in Ihrem Haus ein. Die Bewohneranzahl bestimmt den Haushaltsstrombedarf.</span>
          </span></InputFieldText>
        <NumberPicker
              value={bewohner}
      ...
      <InputDiv>
      <InputFieldText> <span className="tooltip"> Installierte PV-Leistung in kWp <FontAwesomeIcon icon={solid('circle-question')} />
            <span className="tooltiptext"> Bitte geben Sie hier die Nennleistung der Photovoltaik-Anlage an, die auf Ihrem Dach installiert ist oder die Sie auf Ihrem Dach installieren möchten. Wenn Sie keine PV-Leistung angeben, wird von 10 kWp als Empfehlungswert ausgegangen. </span>
          </span></InputFieldText>
        <NumberPicker
              value={pv}
              ...
              max={30}
        />
        <InputFieldText><span className="tooltip"> Nennkapazität Stromspeicher in kWh  <FontAwesomeIcon icon={solid('circle-question')} />
            <span className="tooltiptext">Geben Sie hier die Kapazität des Stromspeichers in kWh an, den Sie in Ihrem Haus installiert haben oder den Sie installieren möchten. Wenn Sie keine Nennkapazität angeben, wird von 5 kWh als Empfehlungswert ausgegangen. </span>
          </span></InputFieldText>
        <NumberPicker
              value={strom}
       ...
       */}
        ...
        <Image>
        <button  className="pointer" onClick={() => setShow(prev => !prev)}>  <div className="tooltip"> Erweiterte Einstellungen  <FontAwesomeIcon icon={solid('circle-question')} />
            <span className="tooltiptext">Für einen noch genaueren Vergleich können Sie hier weitere Angaben tätigen. Das empfehlen wir vor allem Experten.</span>
          </div> </button> </Image>
        {show &&       
      <InputDiv2>
      <h5>Technische Daten <FontAwesomeIcon icon={solid('wrench')} /></h5>

        <InputFieldText><span className="tooltip"> Gebäudestandard   <FontAwesomeIcon icon={solid('circle-question')} />
            <span className="tooltiptext">Der Gebäudestandard von Ihrem Haus bestimmt Ihren Heizwärmebedarf und die Heizlast. Die Auswahl der Nutzereingabe aktiviert die Felder Heizwärmebedarf und Gebäudeheizlast für eine manuelle Eingabe der Werte. Hinweis: Heutige Neubauten entsprechen mindestens dem Gebäudestandard KfW 55 oder besser. Dies ist gesetzlich vorgeschrieben.</span>
          </span></InputFieldText>
        <DropdownList
              value={gebäudestandard}
              onChange={(nextValue) => setGebäudestandard(nextValue)}
              
              data={["KfW 55", "Passivhaus", "GEG-Referenzgebäude", "Nutzereingabe", "KfW 40"]}
        />
        <InputFieldText>  <span className="tooltip"> Heizwärmebedarf in [kWh/(m²a)]  <FontAwesomeIcon icon={solid('circle-question')} />
            <span className="tooltiptext">Der Heizwärmebedarf gibt an, wie viel Wärmeenergie ein Gebäude innerhalb eines Jahres abhängig von seiner zu beheizenden Fläche benötigt, damit in den Räumen die gewünschte Temperatur erreicht wird. </span>
          </span></InputFieldText>
        <Input
        ...
        />
        <InputFieldText><span className="tooltip"> Gebäudeheizlast in [W/m²]  <FontAwesomeIcon icon={solid('circle-question')} />
            <span className="tooltiptext">Die Heizlast wird berechnet, um festzustellen, wie viel Energie eine Heizungsanlage für ein angenehm warmes Haus aufbringen muss.</span>
          </span></InputFieldText>
        <Input
          type="text"
        ...
        <h5>Daten Heizsystem  <FontAwesomeIcon icon={solid('fire')} /></h5>
        <InputFieldText><span className="tooltip"> Heizfenstertyp   <FontAwesomeIcon icon={solid('circle-question')} />
            <span className="tooltiptext">Der Heizfenstertyp wirkt sich auf den Energiebedarf zum Heizen aus. Eine Zweifachverglasung bedeutet größere Verluste als eine Dreifachverglasung.
Hinweis: Bei modernen Gebäuden ist eine Dreifachverglasung Standard. </span>
          </span></InputFieldText>
        <DropdownList
        ...
        />
        <InputFieldText> <span className="tooltip"> TWW-Bereitstellung  <FontAwesomeIcon icon={solid('circle-question')} />
            <span className="tooltiptext">Hier können Sie auswählen, wie Ihr Trinkwarmwasser bereitgestellt werden soll: Ob über eine Trinkwasserwärmepumpe oder einen Durchlauferhitzer. Hier empfehlen wir eine Trinkwasserwärmepumpe.</span>
          </span></InputFieldText>
        <DropdownList
              value={tww}
        ...
        />
        <h5>Daten PV  <FontAwesomeIcon icon={solid('solar-panel')} /></h5>
        <InputFieldText><span className="tooltip"> Monatlicher PV-Ertrag Januar in [kWh/(kWp Mon)] (<a href="https://re.jrc.ec.europa.eu/pvg_tools/en/tools.html">kostenfreies Online-Berechnungstool</a>)  <FontAwesomeIcon icon={solid('circle-question')} /> 
            <span className="tooltiptext">Der monatliche Ertrag Ihrer Photovoltaik-Anlage wird auf Basis des von Ihnen ausgewählten Bundeslandes nach Standardwerten für die Neigung und die Ausrichtung der Photovoltaik-Anlage berechnet. Wenn Sie sich genauere, genau auf Ihren Standort und Ihr Haus abgestimmte Werte für den Ertrag Ihrer Photovoltaik-Anlage berechnen möchten, können Sie die Monatswerte mit dem Online-Berechnungstool bestimmen und dann hier eintragen. </span>
          </span></InputFieldText>
        ...
        <Input
          ...
          value={pvertrag1}
        />
        <InputFieldText>Monatlicher PV-Ertrag Februar in [kWh/(kWp Mon)] </InputFieldText>
        ...
        <Input
          ...
          value={pvertrag2}
        />
        <InputFieldText>Monatlicher PV-Ertrag März in [kWh/(kWp Mon)] </InputFieldText>
          ...
          <Input
            ...
            value={pvertrag3}
          />
          <InputFieldText>Monatlicher PV-Ertrag April in [kWh/(kWp Mon)] </InputFieldText>
          ...
          <Input
            ...
            value={pvertrag4}
          />
          <InputFieldText>Monatlicher PV-Ertrag Mai in [kWh/(kWp Mon)] </InputFieldText>
          ...
          <Input
            ...
            value={pvertrag5}
          />
          <InputFieldText>Monatlicher PV-Ertrag Juni in [kWh/(kWp Mon)] </InputFieldText>
          ...
          <Input
            ...
            value={pvertrag6}
          />
          <InputFieldText>Monatlicher PV-Ertrag Juli in [kWh/(kWp Mon)] </InputFieldText>
          ...
          <Input
            ...
            value={pvertrag7}
          />
          <InputFieldText>Monatlicher PV-Ertrag August in [kWh/(kWp Mon)] </InputFieldText>
          ...
          <Input
            ...
            value={pvertrag8}
          />
          <InputFieldText>Monatlicher PV-Ertrag September in [kWh/(kWp Mon)] </InputFieldText>
          ...
          <Input
            ...
            value={pvertrag9}
          />
          <InputFieldText>Monatlicher PV-Ertrag Oktober in [kWh/(kWp Mon)] </InputFieldText>
          ...
          <Input
            ...
            value={pvertrag10}
          />
          <InputFieldText>Monatlicher PV-Ertrag November in [kWh/(kWp Mon)] </InputFieldText>
          ...
          <Input
            ...
            value={pvertrag11}
          />
          <InputFieldText>Monatlicher PV-Ertrag Dezember in [kWh/(kWp Mon)] </InputFieldText>
...
kann. </span>
        ...
        <NumberPicker
              ...
              min={0}
      />*/}
        <h5>Daten Preise  <FontAwesomeIcon icon={solid('hand-holding-dollar')} /></h5>
        ...
        <NumberPicker
              ...
              min={0}
        />
        <InputFieldText><span className="tooltip"> Einspeisevergütung (konstant) in [€/kWh]  <FontAwesomeIcon icon={solid('circle-question')} />
            <span className="tooltiptext">Wer Strom mit einer Photovoltaik-Anlage erzeugt und diesen Strom in das öffentliche Netz einspeist, erhält eine Einspeisevergütung. Insbesondere in den Sommermonaten erzeugt die Photovoltaik-Anlage viel überschüssigen Strom, der nicht selbst verbraucht werden kann und in das öffentliche Stromnetz eingespeist wird. Die Vergütung dieses eingespeisten PV-Stroms beträgt nach dem EEG 2023 aktuell 8,60 Cent pro eingespeiste Kilowattstunde bei Photovoltaik-Anlagen bis 10 kWp. Dieser Wert ist als Standard ausgewählt. Sie können aber auch einen anderen Wert für die Einspeisevergütung wählen. </span>
          </span></InputFieldText>
        <NumberPicker
