...
export const optionsReductionPrimary = {
  ...
  scales: {
    y: {
        beginAtZero: true,
        title: {display: true, text: 'Eingesparte Primärenergie in kWh/(m² ⋅ a)'}
    },
    x: {
      stacked: true
    }
...
export const optionsReductionCO2 = {
  ...
  scales: {
    y: {
        beginAtZero: true,
        title: {display: true, text: 'Eingesparte CO2-Äquivalent-Emissionen in kg/a'}
    },
    x: {
      stacked: true
    }
