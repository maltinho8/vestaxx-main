...
import {
  ...
  ListPrice,
  ListText,
} from '../PricingTable/pricingtable';
import { MuiAccordion } from '../Accordion/accordion';
import '../../ContentModellierung/index.css';
// images
import gas from '../../../assets/img/img/gas.jpg';
import woodpellets from '../../../assets/img/img/woodpellets.jpg';
import brinewater from '../../../assets/img/img/brinewater.jpg';
import vestaxx from '../../../assets/img/img/vestaxx.jpg';
import heatpump from '../../../assets/img/img/heatpump.jpg';
...
function ContentHeatingComp() {
  const location = useLocation();
  const inputData = location.state.inputBaden;
