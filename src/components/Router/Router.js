  ...
  return (
    <Router>
      ...
      <Routes>
        ...
        <Route path="/HeizvergleichBrandenburg" element={<HeatingCompBrandenburg />} />
        <Route path="/HeizvergleichSachsen" element={<HeatingCompSachsen />} />
        <Route path="/HeizvergleichSachsenAnhalt" element={<HeatingCompSachsenAnhalt />} />
        <Route path="/HeizvergleichSaarland" element={<HeatingCompSaarland />} />
        <Route path="/HeizvergleichThueringen" element={<HeatingCompThueringen />} />
        <Route path="/HeizvergleichNordrhein" element={<HeatingCompNordrhein />} />
        <Route path="/HeizvergleichRheinland" element={<HeatingCompRheinland />} />
        <Route path="/HeizvergleichMecklenburg" element={<HeatingCompMecklenburg />} />
        ...
        <Route path="/HeizvergleichNiedersachsen" element={<HeatingCompNiedersachsen />} />
        <Route path="/HeizvergleichSchleswig" element={<HeatingCompSchleswig />} />
