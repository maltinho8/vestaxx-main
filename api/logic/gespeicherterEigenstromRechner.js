...
function calculateGespeicherterEigenstromJaehrlich(pvErtrag) {
    ...
    if (1 >= konstanten.nennkapazitaetStromspeicher <= 50) {
        return faktorNennkapazitaetRechner.calculateFaktorNennkapazitaet(konstanten.nennkapazitaetStromspeicher) * pvErtrag;
    }
    return 0;
}
...
function calculateGespeicherterEigenstromMonatlich(monatlicheStrombedarfe, monatlichePvErtraege, monatlicheDirekteEigenstromNutzung, iesnMonatlicheWerte) {
    if (1 >= konstanten.nennkapazitaetStromspeicher <= 50) {
        ...
        for (let i = 0; i < iesnMonatlicheWerte.length; i++) {
            gespeicherterEigenstrom[i] = calculateGespeicherterEigenstromProMonat(gesamtPvErtrag, iesnMonatlicheWerte[i], monatlicheDirekteEigenstromNutzung[i], monatlichePvErtraege[i], monatlicheStrombedarfe[i]);
        }
...
function calculateGespeicherterEigenstromProMonat(gesamtPvErtrag, iesn, direkteEigenstromNutzung, pvErtrag, monatlicherStrombedarf) {
    let potenzielleSpeicherMenge = faktorNennkapazitaetRechner.calculateFaktorNennkapazitaet(konstanten.nennkapazitaetStromspeicher) * gesamtPvErtrag * (iesn / 100);
