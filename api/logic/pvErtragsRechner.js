...
function calculatePvErtrag(bundesland, installiertePVLeistung) {
    return sumAllArrayValues(calculatePvErtragMonatlich(bundesland, installiertePVLeistung))
}

function calculatePvErtragMonatlich(bundesland, installiertePVLeistung) {
    let pvErtragBundesland = [];
    for (let i = 0; i < 12; i++) {
        pvErtragBundesland[i] = konstanten.pvErtraege[bundesland.toLowerCase()][i] * installiertePVLeistung;
    }
