...
test("Berechnung des GesamtPrimärEnergieBedarfs", () => {
    ...
    let result = hauptrechner.calculateGesamtPrimaerEnergieBedarfHeizfenster(input);
...
test("Berechnung des GesamtPrimärEnergieBedarfsProQm", () => {
    ...
    let result = hauptrechner.calculateGesamtPrimaerEnergieBedarfHeizfensterProQm(input);
...
test("berechne Gesamtannuität für Heizfenster-System ohne Anrechnung", () => {
    ...
    const result = hauptrechner.calculateGesamtannuitaetHeizfenstersystemOhneAnrechnung(input);
...
test("berechne Gesamtannuität für Heizfenster-System mit Anrechnung", () => {
    ...
    const result = hauptrechner.calculateGesamtannuitaetHeizfenstersystemMitAnrechnung(input);
...
test("berechne Gesamtenergiekosten für Wärmepumpensystem", () => {
    ...
    const result = hauptrechner.calculateGesamtEnergieKostenWaermepumpenSystem(input);
...
test("berechne Gesamtprimärenergiebedarf für Wärmepumpensystem pro QM", () => {
    ...
    const result = hauptrechner.calculateGesamtPrimaerenergiebedarfWaermepumpenSystemProQm(input);
...
test("berechne Gesamtenergiekosten für Sole-Wasser-Wärmepumpensystem", () => {
    ...
    const result = hauptrechner.calculateGesamtEnergieKostenSwWaermepumpenSystem(input);
...
test("berechne Gesamtannuität für Sole-Wasser-Wärmepumpensystem", () => {
    ...
    const result = hauptrechner.calculateGesamtAnnuitaetSwWaermepumpenSystem(input);
...
test("berechne Gesamtenergiekosten für Holzpelletsystem", () => {
    ...
    const result = hauptrechner.calculateGesamtEnergieKostenHolzpelletSystem(input);
...
test("Berechnung Primärenergie Vergleich GEG-Referenzgebäude ohen Anrechnung", () => {
    ...
    let result = hauptrechner.calculateEinsparungPrimaerEnergieOhneAnrechnungGegReferenzgebaeude(input);
...
test("Berechnung Primärenergie Vergleich GEG-Referenzgebäude mit Anrechnung", () => {
    ...
    let result = hauptrechner.calculateEinsparungPrimaerEnergieMitAnrechnungGegReferenzgebaeude(input);
...
test("Berechnung Primärenergie Vergleich Erdgas-BW ohne Anrechnung", () => {
    ...
    let result = hauptrechner.calculateEinsparungPrimaerEnergieOhneAnrechnungErdgasBw(input);
    expect(Math.round(result * 10) / 10).toEqual(32.3);
});
...
test("Berechnung Primärenergie Vergleich Erdgas-BW mit Anrechnung", () => {
    ...
    let result = hauptrechner.calculateEinsparungPrimaerEnergieMitAnrechnungErdgasBw(input);
    expect(Math.round(result * 10) / 10).toEqual(90.7);
});
...
test("Berechnung Primärenergie Vergleich Wärmepumpensystem ohen Anrechnung", () => {
    ...
    let result = hauptrechner.calculateEinsparungPrimaerEnergieOhneAnrechnungWaermepumpe(input);
...
test("Berechnung Primärenergie Vergleich Wärmepumpensystem mit Anrechnung", () => {
    ...
    let result = hauptrechner.calculateEinsparungPrimaerEnergieMitAnrechnungWaermepumpe(input);
...
test("Berechnung Primärenergie Vergleich Erdwärmepumpensystem ohen Anrechnung", () => {
    ...
    let result = hauptrechner.calculateEinsparungPrimaerEnergieOhneAnrechnungErdwaermepumpe(input);
...
test("Berechnung Primärenergie Vergleich Erdwärmepumpensystem mit Anrechnung", () => {
    ...
    let result = hauptrechner.calculateEinsparungPrimaerEnergieMitAnrechnungErdwaermepumpe(input);
...
test("Berechnung Primärenergie Vergleich Holzpellets ohen Anrechnung", () => {
    ...
    let result = hauptrechner.calculateEinsparungPrimaerEnergieOhneAnrechnungHolzpellet(input);
...
test("Berechnung Primärenergie Vergleich Holzpelelts mit Anrechnung", () => {
    ...
    let result = hauptrechner.calculateEinsparungPrimaerEnergieMitAnrechnungHolzpellet(input);
    expect(Math.round(result * 10) / 10).toEqual(56.4);
});
...
test("Vergleich Co2 Emissionen Heizfenstersystem und GEG-Referenzgebäude ohne Anrechnung", () => {
    ...
    expect(Math.round(hauptrechner.calculateEinsparungCo2AeqEmissionenOhneAnrechnungGegReferenzgebaeude(input))).toBe(1443);
});
...
test("Vergleich Co2 Emissionen Heizfenstersystem und GEG-Referenzgebäude mit Anrechnung", () => {
    ...
    expect(Math.round(hauptrechner.calculateEinsparungCo2AeqEmissionenMitAnrechnungGegReferenzgebaeude(input))).toBe(4274)
});
...
test("Vergleich Co2 Emissionen Heizfenstersystem und Erdgas-BW-System ohne Anrechnung", () => {
    ...
    expect(Math.round(hauptrechner.calculateEinsparungCo2AeqEmissionenOhneAnrechnungErdgasBw(input))).toBe(1591);
});
...
test("Vergleich Co2 Emissionen Heizfenstersystem und Erdgas-Bw-System mit Anrechnung", () => {
    ...
    expect(Math.round(hauptrechner.calculateEinsparungCo2AeqEmissionenMitAnrechnungErdgasBw(input))).toBe(4423);
});
...
test("Vergleich Co2 Emissionen Heizfenstersystem und Wärmepumpen-System ohne Anrechnung", () => {
    ...
    expect(Math.round(hauptrechner.calculateEinsparungCo2AeqEmissionenOhneAnrechnungWaermepumpe(input))).toBe(586);
});
...
test("Vergleich Co2 Emissionen Heizfenstersystem und Wärmepumpen-System mit Anrechnung", () => {
    ...
    expect(Math.round(hauptrechner.calculateEinsparungCo2AeqEmissionenMitAnrechnungWaermepumpe(input))).toBe(3418);
});
...
test("Vergleich Co2 Emissionen Heizfenstersystem und Erdwärmenpumpen-System ohne Anrechnung", () => {
    ...
    expect(Math.round(hauptrechner.calculateEinsparungCo2AeqEmissionenOhneAnrechnungErdwaermepumpe(input))).toBe(254);
});
...
test("Vergleich Co2 Emissionen Heizfenstersystem und Erdwärmepumpen-System mit Anrechnung", () => {
    ...
    expect(Math.round(hauptrechner.calculateEinsparungCo2AeqEmissionenMitAnrechnungErdwaermepumpe(input))).toBe(3085);
});
...
test("Vergleich Co2 Emissionen Heizfenstersystem und Holzpelletsystem ohne Anrechnung", () => {
    ...
    expect(Math.round(hauptrechner.calculateEinsparungCo2AeqEmissionenOhneAnrechnungHolzpellet(input))).toBe(-268);
});
...
test("Vergleich Co2 Emissionen Heizfenstersystem und Holzpelletsystem mit Anrechnung", () => {
    ...
    expect(Math.round(hauptrechner.calculateEinsparungCo2AeqEmissionenMitAnrechnungHolzpellet(input))).toBe(2563);
});
...
test("Vergleich Gesamtannuität Heizfenstersystem und Erdgas-BW-System ohne Anrechnung", () => {
    ...
    expect(hauptrechner.calculateReduzierungGesamtAnnuitaetOhneAnrechnungErdgasBw(input)).toBe(-33.20091102703827);
});
...
test("Vergleich Gesamtannuität Heizfenstersystem und Erdgas-BW-System mit Anrechnung", () => {
    ...
    expect(hauptrechner.calculateReduzierungGesamtAnnuitaetMitAnrechnungErdgasBw(input)).toBe(513.1209575275434);
});
...
test("Vergleich Gesamtannuität Heizfenstersystem und Wärmepumpe ohne Anrechnung", () => {
    ...
    expect(hauptrechner.calculateReduzierungGesamtAnnuitaetOhneAnrechnungWaermepumpe(input)).toBe(451.5157671573943);
});
...
test("Vergleich Gesamtannuität Heizfenstersystem und Wärmepumpe mit Anrechnung", () => {
    ...
    expect(hauptrechner.calculateReduzierungGesamtAnnuitaetMitAnrechnungWaermepumpe(input)).toBe(997.837635711976);
});
...
test("Vergleich Gesamtannuität Heizfenstersystem und Erdwärmepumpensystem ohne Anrechnung", () => {
    ...
    expect(hauptrechner.calculateReduzierungGesamtAnnuitaetOhneAnrechnungErdwaermepumpe(input)).toBe(392.0911835396364);
});
...
test("Vergleich Gesamtannuität Heizfenstersystem und Erdwärmepumpensystem mit Anrechnung", () => {
    ...
    expect(hauptrechner.calculateReduzierungGesamtAnnuitaetMitAnrechnungErdwaermepumpe(input)).toBe(938.4130520942181);
});
...
test("Vergleich Gesamtannuität Heizfenstersystem ohne Anrechnung und Holzpelletsystem", () => {
    ...
    expect(hauptrechner.calculateReduzierungGesamtAnnuitaetOhneAnrechnungHolzpellet(input)).toBe(233.20030064019465);
});
...
test("Vergleich Gesamtannuität Heizfenstersystem mit Anrechnung und Holzpelletsystem", () => {
    ...
    expect(hauptrechner.calculateReduzierungGesamtAnnuitaetMitAnrechnungHolzpellet(input)).toBe(779.5221691947763);
});
...
test("Gesamtprimärenergiebedarf pro QM Erdgas-BW-System", () => {
    ...
    expect(hauptrechner.calculateGesamtPrimaerenergiebedarfErdgasBwSystemProQm(input)).toBe(111.10488571573359);
});
...
test("Substituierte Primärenergie pro QM Heizfenster", () => {
    ...
    expect(hauptrechner.calculateSubstituiertePrimaerEnergieHeizfensterProQM(input)).toBe(63.38426938447124);
});
...
test("Gesamtprimärenergiebedarf pro QM Sole-Wasser-Wärmepumpensystem", () => {
    ...
    expect(hauptrechner.calculateGesamtPrimaerenergiebedarfSwWaermepumpenSystemProQm(input)).toBe(61.8);
});
...
test("Gesamtprimärenergiebedarf pro QM Holzpelletsystem", () => {
    ...
    expect(hauptrechner.calculateGesamtPrimaerenergiebedarfHolzpelletSystemProQm(input)).toBe(52.12);
});
...
test("Gesamtprimärenergiebedarf pro QM GEG-Referenzgebäude", () => {
    ...
    expect(hauptrechner.calculateGesamtPrimaerenergiebedarfGegReferenzgebaeudeProQm(input)).toBe(106.56577500433382);
});
...
test("berechne CO2 für Erdgas-BW-System", () => {
    ...
    expect(hauptrechner.calculateCo2ErdgasBwNormal(input)).toBe(4221.614441605827);
});
...
test("berechne CO2 für SW-Wärmepumpen-System", () => {
    ...
    expect(hauptrechner.calculateCo2Erdwaermepumpe(input)).toBe(2884.0000000000005);
});
...
test("berechne substituierte CO2-Emissionen für Heizfenster-System", () => {
    ...
    expect(hauptrechner.calculateSubstituierteCo2EmissionenHeizfenster(input)).toBe(2831.455528502071);
});
...
test("Prognose GEG-Anforderungen normative Vergleichsrechnung Potsdam", () => {
    ...
    expect(hauptrechner.calculatePrognoseGegAnforderungenGegReferenzgebaeudePotsdam(input)).toBe(true);
});
...
test("Prognose KfW Standard normative Vergleichsrechnung Potsdam", () => {
    ...
    expect(hauptrechner.calculatePrognoseKfwStandardGegReferenzgebaeudePotsdam(input)).toBe(false);
});
...
test("PrimaerEnergiebedarfNormativeVergleichsrechnung mit GEG-Referenzgebäude", () => {
    ...
    expect(hauptrechner.berechnePrimaerEnergiebedarfNormativeVergleichsrechnung(input)).toBe(14524.755682909152);
});
...
test("PrimaerEnergiebedarfNormativeVergleichsrechnung mit KfW-40", () => {
    ...
    expect(hauptrechner.berechnePrimaerEnergiebedarfNormativeVergleichsrechnung(input)).toBe(8926.297508958665);
});
