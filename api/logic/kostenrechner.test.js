...
test('berechne Kosten für Strombedarf', () => {
  ...
  expect(kostenrechner.calculateStromkosten(strombedarf, strompreis)).toEqual(
    1643.9499999999998
  );
});
...
test('berechne Kosten für Erdgasbedarf', () => {
  ...
  expect(
    kostenrechner.calculateErdgasKosten(erdgasbedarf, erdgaspreis)
  ).toEqual(144);
});
...
test('berechne Investionskosten Erdgas BW System', () => {
  ...
  const result = kostenrechner.calculateInvestitionskostenErdgasBWSystem(
...
test('berechne Gesamtannuität Erdgas-BW-System', () => {
  ...
  const stromkosten = 1225.0;

  const result = kostenrechner.calculateGesamtannuitaetErdgasBW(
    anzahlBeheizterRaeume,
    erdgaskosten,
    stromkosten
  );
...
test('berechne Investitionskosten Heizfenstersystem', () => {
  ...
  const result = kostenrechner.calculateInvestitionskostenHeizfenstersystem(
...
test('berechne Gesamtannuität Heizfenstersystem ohne Anrechnung', () => {
  ...
  const result =
    kostenrechner.calculateGesamtannuitaetHeizfenstersystemOhneAnrechnung(
...
test('berechne Gesamtannuität Heizfenstersystem mit Anrechnung', () => {
  ...
  const result =
    kostenrechner.calculateGesamtannuitaetHeizfenstersystemMitAnrechnung(
      investitionHeizfenstersystem,
      gesamtStromkosten,
...
test('berechne Gesamtenergiekosten für Erdgas-BW-System', () => {
  ...
  const result = kostenrechner.calculateGesamtEnergiekosten(
    erdgaskosten,
    stromkosten
  );
...
test('berechne Kostenunterschiede Gesamtannuität', () => {
  ...
  const result = kostenrechner.calculateReduzierungGesamtannuitaet(
    gesamtannuitaetErdgasBW,
    gesamtannuitaetHeizfenster
  );
...
test('berechne Investitionskosten Luft-Wasser-Wärmepumpensystem', () => {
  ...
  const result =
    kostenrechner.calculateInvestitionskostenWaermepumpenSystem(
      gebaeudenutzflaeche
    );
...
test('berechne Gesamtenergiekosten Luft-Wasser-Wärmepumpensystem', () => {
  ...
  const result = kostenrechner.calculateGesamtEnergiekostenWaermepumpenSystem(
    twwBedarf,
    heizwaermebedarf,
...
test('berechne Gesamtannuität Luft-Wasser-Wärmepumpensystem', () => {
  ...
  const result = kostenrechner.calculateGesamtAnnuitaetWaermepumpenSystem(
    gebaeudenutzflaeche,
    heizwaermebedarf,
    twwBedarf,
    haushaltsstrombedarf,
...
test('berechne Investitionskosten Sole-Wasser-Wärmepumpensystem', () => {
  ...
  const result =
    kostenrechner.calculateInvestitionskostenSwWaermepumpenSystem(
      gebaeudenutzflaeche
    );
...
test('berechne Gesamtenergiekosten Sole-Wasser-Wärmepumpensystem', () => {
  ...
  const result = kostenrechner.calculateGesamtEnergieKostenSwWaermepumpenSystem(
    heizwaermebedarf,
    twwBedarf,
    haushaltsstrombedarf,
    strompreis
...
test('berechne Gesamtannuität Sole-Wasser-Wärmepumpensystem', () => {
  ...
  const result = kostenrechner.calculateGesamtAnnuitaetSwWaermepumpenSystem(
    gebaeudenutzflaeche,
    heizwaermebedarf,
    twwBedarf,
    haushaltsstrombedarf,
...
test('berechne Investitionskosten Holzpelletsystem', () => {
  ...
  const result =
    kostenrechner.calculateInvestitionskostenHolzpelletSystem(
      gebaeudenutzflaeche
    );
...
test('berechne Gesamtenergiekosten Holzpelletsystem', () => {
  ...
  const result = kostenrechner.calculateGesamtEnergiekostenHolzpelletSystem(
    heizwaermebedarf,
    twwBedarf,
    haushaltsstrombedarf,
    strompreis
...
test('berechne Gesamtannuität Holzpelletsystem', () => {
  ...
  const result = kostenrechner.calculateGesamtannuitaetHolzpelletSystem(
    gebaeudenutzflaeche,
    heizwaermebedarf,
    twwBedarf,
    haushaltsstrombedarf,
