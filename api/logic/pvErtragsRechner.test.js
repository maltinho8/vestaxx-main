...
test("Berechnung der GesamtPVErträge pro Bundesland", () => {
    ...
    expect(pvertragsrechner.calculatePvErtrag("mecklenburg-vorpommern", 1)).toBe(990);
    ...
    expect(pvertragsrechner.calculatePvErtrag("nordrhein-westphalen", 1)).toBe(1032);
...
test("Berechnung der GesamtPVErträge auf Grund monatlicher pvertrage aus Nutzereingabe", () => {
    ...
    expect(pvertragsrechner.calculatePvErtragNutzereingabe(pvErtragNutzereingabeArray)).toBe(12);
})
